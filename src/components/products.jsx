...
function Products({ onAddToCart }) {
  const products = [
    { id: 1, title: "Clavier", oldPrice: "500 MAD", price: 299, image: "./images/cassque.png", availableColors: ["White", "Black", "Red"] },
    { id: 2, title: "Souris", oldPrice: "500 MAD", price: 299, image: "./src/assets/CLAVIER.jpg", availableColors: ["Blue", "Red", "Yellow"] },
    { id: 3, title: "Manette de jeu", oldPrice: "500 MAD", price: 299, image: "./src/assets/manette.jpg", availableColors: ["Black", "White", "Red"] },
    { id: 4, title: "Casque audio", oldPrice: "500 MAD", price: 299, image: "./src/assets/souris.jpg", availableColors: ["Red", "White", "Blue"] },
    { id: 5, title: "Webcam", oldPrice: "500 MAD", price: 299, image: "./src/assets/cam.png", availableColors: ["Black", "White", "Red"] }
  ];
